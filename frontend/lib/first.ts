...
const products = [
  ...
  },
  {
    ...
    deliveryDate: "5-7 өдөрт хүргэнэ",
    seller: "Rajwadi Poshaak Co.",
    color: ["Pink and White Green"],
    category: "bedsheets",
    model: "RP-101 BS)",
    size: ["KING SIZE 90X108 INCHES", "SUPERKING SIZE 108X108 INCHES"],
    images: [
  ...
  },
  {
    ...
    description:
      "floral print fit and flare dress with sleeve and Good fabric.",
    chartData: [
      {
        month: "Jan",
        revenue: 9482,
  ...
  },
  {
    ...
    model: "RP-769 WD)",
    size: ["XS", "S", "M", "L", "XL", "XXL", "3XL"],
    images: ["/detailphotos/171.1.webp", "/detailphotos/171.2.webp"],
    features: [
      "Хүргэлт : 5-7 өдөрт хүргэнэ",
      "Fabric - Pure Cotton",
  ...
  },
  {
    ...
    description:
      "Indulge in luxury with our Gerua Chanderi Silk Unstitched Suit Set. Made with high-quality chanderi silk, this set exudes elegance and sophistication. Unleash your inner fashionista with this exclusive piece, perfect for any occasion. Experience the art of fine dressing with Gerua.",
    chartData: [
      {
        month: "Jan",
        revenue: 2917,
  ...
  },
  {
    ...
    description:
      "Solid print fit and flare T-shirt with sleeve and Good fabric.",
    chartData: [
      {
        month: "Jan",
        revenue: 1764,
  ...
  },
  {
    ...
    description:
      "Unleash your inner wildflower with this stunning white dress featuring intricate embroidery detailing. Perfect for those who love to take risks, this dress will make you feel bold and adventurous. Stand out from the crowd and embrace the challenge of standing out with this unique and beautiful dress.",
    chartData: [
      {
        month: "Jan",
        revenue: 3791,
  ...
  },
  {
    ...
    description:
      "Graphic print fit and flare Kurta with Gathered detail and Good fabric.",
    chartData: [
      {
        month: "Jan",
        revenue: 2607,
