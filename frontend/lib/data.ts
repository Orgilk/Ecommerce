...
export const products: Product[] = [
  ...
  },
  {
    ...
    model: "RP-806)",
    size: ["XS", "S", "M", "L", "XL", "XXL", "XXL"],
    images: ["/detailphotos/24.1.webp", "/detailphotos/24.2.webp"],
    features: [
      "Dispatch Time : 5-7 өдөрт хүргэнэ",
      "Fabric - Pure Cotton",
  ...
  },
  {
    ...
    model: "RP-813)",
    size: ["XS", "S", "M", "L", "XL"],
    images: ["/detailphotos/27.1.webp", "/detailphotos/27.2.webp"],
    features: [
      "Dispatch Time : 5-7 өдөрт хүргэнэ",
      "Fabric - Pure Cotton",
  ...
  },
  {
    ...
    description:
      "НАТУРВИТ - ЧАЦАРГАНАТАЙ ВИТАМИН, Антиоксидант, Томуу, томуу төст өвчнөөс урьдчилан сэргийлэх, Биеийн эсэргүүцлийн сайжруулна, НАТУРВИТ - ЦАЙРТАЙ ВИТАМИН C, Антиоксидант, Биеийн эсэргүүцлийн сайжруулна, Үс, арьс, хумсны коолагены нийлэгжилтийг сайжруулах үйлчилгээтэй, Энэхүү бүтээгдэхүүн оношлох, kurta-setsчлэх зорилгоор хийгдээгүй болно.б, Эрүүл энх амьдралын төлөө хамтдаа",
    chartData: [
      {
        month: "Jan",
        revenue: 5941,
  ...
  },
  {
    ...
    model: "RP-814)",
    size: ["XS", "S", "M", "L", "XL", "XXL"],
    images: ["/detailphotos/vitamina.png"],
  ...
  },
  {
    ...
    model: "RP-787)",
    size: ["XS", "S", "M", "L", "XL", "XXL"],
    images: ["/detailphotos/vitamine.png"],
  ...
  },
  {
    ...
    seller: "Rajwadi Poshaak Co.",
    color: ["Cream"],
    category: "шинээр нkurta-setsэгдсэн",
    model: "",
    size: ["XS", "S", "M", "L", "XL", "XXL"],
    images: ["/detailphotos/vitamind.png"],
