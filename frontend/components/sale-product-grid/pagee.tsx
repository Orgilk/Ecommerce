...
// // import { products as productData } from "product/data.ts";
...
//     //     try {
//     //         setIsLoading(true);
//     //         // const response = await fetch('/api/category'); \product\[id]\data.ts
//     //         const response = await fetch('/product/[id]/data.ts');
