...
function FileUploadDemo() {
  ...
  return (
    <div className="space-y-8 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 min-h-screen">
      ...
      >
        <h1 className="text-3xl font-bold mb-4 text-center text-red-700 dark:text-red-300">
          Find Similar Clothes
        </h1>
        <p className="text-center mb-6 text-gray-600 dark:text-gray-300">
          Upload an image or use your camera to find similar clothing items
          using our AI-powered model
        </p>
      ...
      {previewUrls.length > 0 && (
        ...
        >
          <h2 className="text-2xl font-semibold mb-4 text-red-700 dark:text-red-300">
            Uploaded Images
          </h2>
      ...
      {productImagePaths.length > 0 && (
        <motion.div
          ...
          className="w-full bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg"
        >
          <h2 className="text-2xl font-semibold mb-6 text-red-700 dark:text-red-300">
            AI-Recommended Products
          </h2>
          <div className="bg-red-100 dark:bg-red-900 p-4 rounded-lg mb-4">
            <p className="text-black dark:text-white text-base">
              <span className="text-red-600 dark:text-red-300 text-lg font-semibold">
                Note:
              </span>{" "}
              If the uploaded image is not a clothing item, our AI might still
              suggest products based on similar features or patterns. Please
              note that our AI model is continuously learning and may
              occasionally make mistakes. We appreciate your understanding and
              encourage you to try uploading a different image for better
              results.
            </p>
          </div>
          {loading ? (
